/**
 * ResourceContentResponseType.java
 *
...
/**
 * Resource content response containing ID, revision, type, result
 * code and description (on error).
 */
public class ResourceContentResponseType  extends com.streamserve.schemas.webservice.types.object._1_0.ResourceResultType  implements java.io.Serializable {
    ...
    public ResourceContentResponseType() {
    }
    ...
    /**
     * Gets the data value for this ResourceContentResponseType.
     * 
    ...
    /**
     * Sets the data value for this ResourceContentResponseType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResourceContentResponseType)) return false;
        ResourceContentResponseType other = (ResourceContentResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResourceContentResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.streamserve.com/webservice/types/content/base64/1.0", "ResourceContentResponseType"));
