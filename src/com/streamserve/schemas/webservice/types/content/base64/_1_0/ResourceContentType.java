...
/**
 * Resource content containing resource ID and binary content.
 */
public class ResourceContentType  extends com.streamserve.schemas.webservice.types.object._1_0.ResourceIDType  implements java.io.Serializable {
    ...
    /**
     * Gets the data value for this ResourceContentType.
     * 
    ...
    /**
     * Sets the data value for this ResourceContentType.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.streamserve.com/webservice/types/content/base64/1.0", "ResourceContentType"));
