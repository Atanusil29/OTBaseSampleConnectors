...
public class ContentType  implements java.io.Serializable {
     ...
     * 
     * @return content   * Binary content (as Base64).
     */
     ...
     * 
     * @param content   * Binary content (as Base64).
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.streamserve.com/webservice/types/content/base64/1.0", "ContentType"));
